...
class CurriculumsControllerTest < ActionController::TestCase
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post :create, curriculum: { author: @curriculum.author, course_description: @curriculum.course_description, syllabus: @curriculum.syllabus, worksheets: @curriculum.worksheets }
    end
  ...
  test "should update curriculum" do
    patch :update, id: @curriculum, curriculum: { author: @curriculum.author, course_description: @curriculum.course_description, syllabus: @curriculum.syllabus, worksheets: @curriculum.worksheets }
    assert_redirected_to curriculum_path(assigns(:curriculum))
  end
